...
const Landing = () => {
  ...
  return <div className="min-h-screen bg-white">
      <HeroSection showWordPressSection={showWordPressSection} setShowWordPressSection={setShowWordPressSection} />

      {/* WordPress Houses Section */}
      {showWordPressSection}

      <HouseCardSection onBookNow={handleBookNow} onViewDetails={handleViewDetails} />

      <CTASection />

      <LandingFooter />

      <UserBookingFormDialog open={showBookingDialog} onOpenChange={setShowBookingDialog} defaultHouseId={selectedHouseId} onSubmit={handleBookingSubmit} />

      <HouseDetailDialog open={showHouseDetail} onOpenChange={setShowHouseDetail} houseId={selectedHouseId} />
    </div>;
};
